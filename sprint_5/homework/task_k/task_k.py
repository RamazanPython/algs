...
Если корень дерева больше левой границы, то ведет поиск в левом поддереве.
Если текущее значение корня входит в диапазон, то добавляем в массив
Если корень дерева меньше правой границы, то ищем в правом поддереве
"""
